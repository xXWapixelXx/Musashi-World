...
function init() {
 ...
 platforms = [
    ...
    new Platform({ x: platformImage.width * 4 + 150 - 2 + platformImage.width - platformSmallTallImage.width, y: 270, image: createImage(platformSmallTall)}),
  new Platform(
...
), new Platform({ x: platformImage.width *6 + 700 - 3, y: 470, image: platformImage })
]; 
 genericObjects = [
  new GenericObject({
    x: -1,
